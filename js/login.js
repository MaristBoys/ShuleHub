...
import {
    ...
    triggerNavbarPulse,
    getDeviceInfo
} from '/ShuleHub/js/utils.js';
import { fetchAndCacheDropdownData, fetchAndCacheArchivedFiles } from '/ShuleHub/js/prefetch.js';
...
export async function logout() {
    ...
    //window.location.replace("/ShuleHub/index.html");
