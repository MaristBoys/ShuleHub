// js/archive.js
import { loadNavbar, initializeThemeToggle, buildArchivedFilesRequestParams, updateUIForLoginState } from '/ShuleHub/js/utils.js';
import { fetchAndCacheArchivedFiles } from '/ShuleHub/js/prefetch.js';
import { logout } from '/ShuleHub/js/login.js';
